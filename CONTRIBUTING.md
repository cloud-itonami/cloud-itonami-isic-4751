...
`cloud-itonami-isic-4751` accepts contributions to the OSS blueprint,
...
- Never phrase a governor scope-exclusion term as a bare noun (e.g.
  ...
  (e.g. "issue the refund"), and add/extend the
  ...
  `textileops.governor/scope-excluded-terms`'s docstring.
