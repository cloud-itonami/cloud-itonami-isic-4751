...
`cloud-itonami-isic-4751` is an OSS open-business blueprint for
fabric/notions retail operations coordination (ISIC Rev.5 4751 -- retail
...
- the TextileRetailGovernor remains independent of the advisor.
